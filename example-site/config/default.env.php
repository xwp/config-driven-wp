...
return array(
	...
	'WP_CACHE_KEY_SALT' => 'config-driven-wp.dev',
	 ...
	 * @since 2.6.0
	 */
	'AUTH_KEY'         => 'supply via $_SERVER[WP...] or via *-overrides.env.php',
	'SECURE_AUTH_KEY'  => 'supply via $_SERVER[WP...] or via *-overrides.env.php',
	'LOGGED_IN_KEY'    => 'supply via $_SERVER[WP...] or via *-overrides.env.php',
	'NONCE_KEY'        => 'supply via $_SERVER[WP...] or via *-overrides.env.php',
	'AUTH_SALT'        => 'supply via $_SERVER[WP...] or via *-overrides.env.php',
	'SECURE_AUTH_SALT' => 'supply via $_SERVER[WP...] or via *-overrides.env.php',
	'LOGGED_IN_SALT'   => 'supply via $_SERVER[WP...] or via *-overrides.env.php',
	'NONCE_SALT'       => 'supply via $_SERVER[WP...] or via *-overrides.env.php',
